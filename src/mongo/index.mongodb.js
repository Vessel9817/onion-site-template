 ...
 *
 * NOTE: This script will only run when the DB data volume hasn't been previously initialized
 */
...
try {
    ...
    // For some reason, environment variables need to be manually included, even when set by Docker
